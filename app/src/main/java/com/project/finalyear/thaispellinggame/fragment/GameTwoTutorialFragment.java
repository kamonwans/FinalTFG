...
public class GameTwoTutorialFragment extends Fragment {

    CountDownTimer countDownTimer;
    private static TextView tvTimer;
    CircleProgressbar circleProgressbar;

    public GameTwoTutorialFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_game_two_tutorial, container, false);
        initInstance(view);
        return view;
    }
    ...
    public void FragmentGameTwo() {
        Fragment fragment = new GameTwoFragment();
