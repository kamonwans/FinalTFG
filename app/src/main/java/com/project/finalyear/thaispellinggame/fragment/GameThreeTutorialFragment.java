...
public class GameThreeTutorialFragment extends Fragment {
    CountDownTimer countDownTimer;
    private static TextView tvTimer;
    CircleProgressbar circleProgressbar;

    public GameThreeTutorialFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_game_three_tutorial, container, false);
        initInstance(view);
        return view;
    }
    ...
    public void FragmentGameThree() {
        Fragment fragment = new GameThreeFragment();
