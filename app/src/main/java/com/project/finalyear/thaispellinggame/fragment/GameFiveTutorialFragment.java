...
public class GameFiveTutorialFragment extends Fragment {
    CountDownTimer countDownTimer;
    private static TextView tvTimer;
    CircleProgressbar circleProgressbar;
    public GameFiveTutorialFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_game_five_tutorial, container, false);
        initInstance(view);
        return view;
    }
    ...
    public void FragmentGameFive() {
        Fragment fragment = new GameFiveFragment();
