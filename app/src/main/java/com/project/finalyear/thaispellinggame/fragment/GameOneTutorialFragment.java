...
public class GameOneTutorialFragment extends Fragment {

    CountDownTimer countDownTimer;
    private static TextView tvTimer;
    CircleProgressbar circleProgressbar;

    public GameOneTutorialFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_game_one_tutorial, container, false);
        initInstance(view);
        return view;
    }
